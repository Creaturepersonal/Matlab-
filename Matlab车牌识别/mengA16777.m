...
img1 = bwareaopen(g, 200);
figure;
imshow(img1);title('移除面积小于200后的图像');
split_img = split(img1);
figure;
...
%对每一个字符进行识别
distinguish_code = char(['0':'9' 'A':'Z' '京辽鲁陕苏豫浙贵晋蒙']);
